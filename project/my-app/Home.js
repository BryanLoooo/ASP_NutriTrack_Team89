          ...
          {articles.map((article) => (
            <TouchableOpacity
              ...
              style={[
                ...
                selectedArticle === article && styles.selectedArticleButton,
              ]}
        ...
        <View style={styles.dailyProgressItem}>
            ...
            <View style={styles.progressBar}>
              <View
                style={[
                  ...
                  { width: `${(caloriesConsumed / caloriesGoal) * 100}%` },
                ]}
              />
            </View>
          </View>
          <View style={styles.statsContainer}>
            <Text style={styles.dailyProgressText}>
              Calories: {caloriesConsumed} cals
            </Text>
            <Text style={styles.dailyProgressText}>
            ...
            <Text style={styles.dailyProgressText}>
              Carbohydrates: {carbohydrateConsumed}g
            </Text>
          </View>
        </View>
      </View>
      <View style={styles.dailyProgressContainer}>
        ...
        <View style={styles.dailyProgressItem}>
          ...
          <View
            style={[
              styles.dailyProgressFill,
              { backgroundColor: "green", width: "40%" },
            ]}
          />
        </View>
        <View style={styles.dailyProgressItem}>
        ...
        <View style={styles.dailyProgressItem}>
          ...
          <View
            style={[
              styles.dailyProgressFill,
              { backgroundColor: "green", width: "60%" },
            ]}
          />
        </View>
        <View style={styles.dailyProgressItem}>
          ...
          <View
            style={[
              styles.dailyProgressFill,
              { backgroundColor: "green", width: "70%" },
            ]}
          />
        </View>
      </View>
